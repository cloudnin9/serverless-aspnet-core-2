...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *cs_web_api*):
...
Execute unit tests
```
    cd "cs_web_api/test/cs_web_api.Tests"
    dotnet test
```

Deploy application
```
    cd "cs_web_api/src/cs_web_api"
